...
[![An example of a Huffman code tree](./readme/huffman.png#thumbnail)](./readme/huffman.png)
...
## **Treap** [Chapter 3](https://livebook.manning.com/book/algorithms-and-data-structures-in-action/chapter-3) | [Java](https://github.com/mlarocca/AlgorithmsAndDataStructuresInAction/tree/master/Java/src/org/mlarocca/containers/treap) | [profiling notebook](https://github.com/mlarocca/AlgorithmsAndDataStructuresInAction/blob/master/Python/mlarocca/notebooks/treaps_profiling.ipynb)

[![Treap](./readme/treap.png#thumbnail)](./readme/treap.png)
...
[![Checking a value in a Bloom filter](./JavaScript/readme/bloom_filter.png#thumbnail)](./JavaScript/readme/bloom_filter.png)
...
[![An example of disjoint set](./JavaScript/readme/union_find.png#thumbnail)](./JavaScript/readme/union_find.png)
...
[![An example of a trie](./JavaScript/readme/trie.png#thumbnail)](./JavaScript/readme/trie.png)
...
[![An example of compressing a trie into a radix tree](./JavaScript/readme/radix_tree_compression.png#thumbnail)](./JavaScript/readme/radix_tree_compression.png)
...
## _Bonus_: **Needleman-Wunsch** algorithm for string alignment [JavaScript](https://github.com/mlarocca/AlgorithmsAndDataStructuresInAction/tree/master/JavaScript/src/strings)
...
[![A tri-dimensional k-d tree](./JavaScript/readme/k-d_tree.png#thumbnail)](./JavaScript/readme/k-d_tree.png)
...
[![An example of a similarity-search tree](./JavaScript/readme/ss_tree.png#thumbnail)](./JavaScript/readme/ss_tree.png)
...
## **K-means** [Chapter 12](https://livebook.manning.com/book/algorithms-and-data-structures-in-action/chapter-12) - [Chapter 13]((https://livebook.manning.com/book/algorithms-and-data-structures-in-action/chapter-13)) | [Python](https://github.com/mlarocca/AlgorithmsAndDataStructuresInAction/blob/master/Python/mlarocca/datastructures/clustering/kmeans.py) | [Jupyter notebook](https://github.com/mlarocca/AlgorithmsAndDataStructuresInAction/blob/master/Python/mlarocca/notebooks/k_means.ipynb) | [profiling](https://github.com/mlarocca/AlgorithmsAndDataStructuresInAction/blob/master/Python/mlarocca/notebooks/kmeans_profiling.ipynb)

[![K-means](./readme/k-means.jpg#thumbnail)](./readme/k-means.jpg)
...
## **DBSCAN** [Chapter 12](https://livebook.manning.com/book/algorithms-and-data-structures-in-action/chapter-12) - [Chapter 13]((https://livebook.manning.com/book/algorithms-and-data-structures-in-action/chapter-13)) | [Python](https://github.com/mlarocca/AlgorithmsAndDataStructuresInAction/blob/master/Python/mlarocca/datastructures/clustering/dbscan.py) | [Jupyter notebook](https://github.com/mlarocca/AlgorithmsAndDataStructuresInAction/blob/master/Python/mlarocca/notebooks/dbscan.ipynb)

[![DBSCAN](./readme/db_scan_steps.png#thumbnail)](./readme/db_scan_steps.png)
...
[![A dendrogram produced by OPTICS](./readme/optics_dendrogram.jpg#thumbnail)](./readme/optics_dendrogram.jpg)
...
[![Canopy Clustering](./readme/canopy_clustering.jpg#thumbnail)](./readme/canopy_clustering.jpg)
